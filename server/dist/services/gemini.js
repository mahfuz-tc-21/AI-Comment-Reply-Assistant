...
const systemPrompt_1 = require("../prompt/systemPrompt");
...
class GeminiProvider {
    ...
    async analyzeComments(platform, content, comments, settings, apiKey) {
        ...
        const systemPrompt = (0, systemPrompt_1.getSystemPrompt)(settings?.brandName, settings?.brandTone, settings?.customInstructions);
        const userPrompt = `
Platform: ${platform}
...
`;
    ...
    generateMockAIResponse(comments, content) {

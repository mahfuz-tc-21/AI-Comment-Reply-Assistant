export function getSystemPrompt(
  brandName: string = 'Programming Hero',
  tone: string = 'Friendly, helpful, conversational, human, context-aware',
  customInstructions: string = 'Keep replies to 1-3 sentences. Sound like a friendly team member, not an AI.'
): string {
